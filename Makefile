...
ifeq ($(ENABLE_AIS),1)
ifeq ($(ENABLE_DIGITAL_MODULATION),0)
$(error ENABLE_AIS requires ENABLE_DIGITAL_MODULATION=1)
endif
	CFLAGS  += -DENABLE_AIS
ifeq ($(ENABLE_AIS_IDENTITY),1)
	CFLAGS  += -DENABLE_AIS_IDENTITY -DAIS_AUTHOR_STRING=\"$(AIS_AUTHOR_STRING)\"
endif
endif
